...
One problem was trying to make sure the layout looked decent across all the xml files. I also ran into the problem of having images be duplicated while scrolling which took up a lot of time to fix.
